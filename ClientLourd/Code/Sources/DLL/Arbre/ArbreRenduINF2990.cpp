...
void ArbreRenduINF2990::initialiser()
{
	...
	//3noeudMurBordTable1->setPoints(point1, point2);
	point1 = glm::dvec3(-48.0, 24.0, 0.0);
	point2 = glm::dvec3(48.0, 24.0, 0.0);
	//3noeudMurBordTable2->setPoints(point1, point2);
	point1 = glm::dvec3(-48.0, -24.0, 0.0);
	point2 = glm::dvec3(-48.0, 24.0, 0.0);
	//3noeudMurBordTable3->setPoints(point1, point2);
	point1 = glm::dvec3(48.0, -24.0, 0.0);
	point2 = glm::dvec3(48.0, 24.0, 0.0);
	//3noeudMurBordTable4->setPoints(point1, point2);
	...
	if (!chargerFichierXMl_){
		...
		noeudFleche->assignerPositionRelative(glm::dvec3(42.0, 0.0, 1.0));
		noeudFleche->assignerRedimensionnementRelative(glm::dvec3(1.0, 1.0, 1.0));
		noeudFleche->ID = "Fleche1";
		//noeudFleche->tourner(90.0);

		/*NoeudAbstrait* noeudFleche2 = ajouterNouveauNoeud(NOM_TABLE, NOM_FLECHE);
		noeudFleche2->assignerPositionRelative(glm::dvec3(-42.0, 0.0, 1.0));
		noeudFleche2->assignerRedimensionnementRelative(glm::dvec3(1.0, 1.0, 1.0));
		noeudFleche2->ID = "Fleche2";

		NoeudAbstrait* noeudFleche3 = ajouterNouveauNoeud(NOM_TABLE, NOM_FLECHE);
		noeudFleche3->assignerPositionRelative(glm::dvec3(-1.8, 15.0, 1.0));
		noeudFleche3->assignerRedimensionnementRelative(glm::dvec3(1.0, 1.0, 1.0));
		noeudFleche3->ID = "Fleche3";

		NoeudAbstrait* noeudFleche4 = ajouterNouveauNoeud(NOM_TABLE, NOM_FLECHE);
		noeudFleche4->assignerPositionRelative(glm::dvec3(-1.8, -15.0, 1.0));
		noeudFleche4->assignerRedimensionnementRelative(glm::dvec3(1.0, 1.0, 1.0));
		noeudFleche4->ID = "Fleche4";*/
	}
