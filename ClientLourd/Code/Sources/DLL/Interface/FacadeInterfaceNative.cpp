...
extern "C"
{
	...
	*/
	...
	__declspec(dllexport) const char * __cdecl ChangerConfigurationObjetSelectionne(double x, double y, double rotation, double echelle)
	{
	...
	__declspec(dllexport) int __cdecl getMySelectedNodesNumber()
	{
		return FacadeModele::obtenirInstance()->getMySelectedNodesNumber();
	}

	__declspec(dllexport) const char * __cdecl getInfosRobot()
	{
		return FacadeModele::obtenirInstance()->getInfosRobot();
	}
	
	__declspec(dllexport) void __cdecl mettreAjourRobot(char * chaineRobot)
	{
		FacadeModele::obtenirInstance()->mettreAjourRobot(chaineRobot);
	}
	
	__declspec(dllexport) const char * __cdecl getMySelectedNodesString()
	{
		return FacadeModele::obtenirInstance()->getMySelectedNodesString();
	}
	
	__declspec(dllexport) const char * __cdecl getDuplicatedNodesStr()
	{
		return FacadeModele::obtenirInstance()->getDuplicatedNodesStr();
	}
	//SetRobotUsername(char * username)
	__declspec(dllexport) void __cdecl SetRobotUsername(char * username)
	{
		FacadeModele::obtenirInstance()->SetRobotUsername(username);
	}
	//void __cdecl );
	__declspec(dllexport) bool __cdecl ChangerConfigurationObjetSelOnline(double x, double y, double rotation, double echelle)
	{
		return FacadeModele::obtenirInstance()->ChangerConfigurationObjetSelOnline(x,y,rotation,echelle);
	}

	__declspec(dllexport) void __cdecl initialiserFleches(char * fleche)
	{
		FacadeModele::obtenirInstance()->initialiserFleches(fleche);
	}
	
	__declspec(dllexport) void __cdecl supprimerDernierNoeudOnline(char * id)
	{
		FacadeModele::obtenirInstance()->supprimerDernierNoeudOnline(id);
	}
	
	__declspec(dllexport) void __cdecl EnleverFlechesOnline()
	{
		FacadeModele::obtenirInstance()->EnleverFlechesOnline();
	}
}
