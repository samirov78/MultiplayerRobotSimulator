...
public:
   ...
   void CreateRobot(std::string id);
   ...
   void ModifyFleche(const char* data);
   ...
   const char * ChangerConfigurationObjetSelectionne(double x, double y, double rotation, double echelle);
   ...
   void SetRobotUsername(char * username);
   void mettreAjourRobot(char * chaineRobot);

   std::string chaineDeSauvegarde;
   std::string chaineDeDeplacement;
   std::string mySelectedIDs_;
   std::string chaineDeDuplication;
   std::string chaineConfig;
   int compteurDupliques = 1;
   std::vector<std::string> mySelectedNodesIDs;
   int getMySelectedNodesNumber();
   std::string username_;
   void assignerPositionPourObjetSelOnline(double x, double y, double z);
   void PivoterObjetSelOnline(double deltaY);
   const char * getInfosRobot();
   const char * getMySelectedNodesString();
   const char * getDuplicatedNodesStr();
   bool ChangerConfigurationObjetSelOnline(double x, double y, double angle, double scale);
   void initialiserFleches(char * fleche);
   void supprimerDernierNoeudOnline(char * id);
   void EnleverFlechesOnline();
   std::string chaineRobot_;
   std::vector<NoeudAbstrait *> noeudsDuliques ;
   std::mutex mtx;
   std::string Fleche_ = "Fleche1";
   NoeudAbstrait * fleche2 = NULL;
   NoeudAbstrait * fleche3 = NULL;
   NoeudAbstrait * fleche4 = NULL;
